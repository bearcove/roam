...
> r[zerocopy]
>
> Telex aims to minimize copies at every layer. This document specifies how
...
> converted to `Box<[u8]>`. One copy at the Telex link boundary (transport-
...
> r[zerocopy.copies]
>
> Copy counts are measured at the Telex link boundary — copies internal to
