// Browser test for telex in-process transport.
//
...
import { InProcessLink } from "@bearcove/telex-inprocess";
import {
  session,
} from "@bearcove/telex-core";
import type { TestbedClient } from "@bearcove/telex-generated/testbed.generated.ts";
...
async function runTests(): Promise<void> {
  ...
  try {
    ...
    const { TestbedClient } = await import(
      "@bearcove/telex-generated/testbed.generated.ts"
    );
