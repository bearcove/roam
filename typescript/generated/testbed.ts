...
export type MathError = { tag: "DivisionByZero" } | { tag: "Overflow" };
...
export type LookupError = { tag: "NotFound" } | { tag: "AccessDenied" };
  ...
  divide(
    ...
    return new CallBuilder(async (metadata) => {
      try {
        ...
        return { ok: true, value: response } as
...
export interface TestbedHandler {
  ...
  lookup(
    ...
    | Promise<{ ok: true; value: Person } | { ok: false; error: LookupError }>
    | { ok: true; value: Person }
    | { ok: false; error: LookupError };
    ...
    async (handler, payload, requestId, registry, taskSender) => {
      try {
        ...
        taskSender({
          kind: "response",
          requestId,
          payload: pc.concat(pc.encodeU8(0), pc.encodeString(result)),
        });
      } catch (e) {
        taskSender({
          kind: "response",
          requestId,
          payload: pc.concat(pc.encodeU8(1), pc.encodeVarint(2n)),
        });
      }
    },
  ],
      ...
      try {
        ...
        if (result.ok) {
          taskSender({
            kind: "response",
            requestId,
            payload: pc.concat(pc.encodeU8(0), pc.encodeI64(result.value)),
          });
        } else {
          taskSender({
            kind: "response",
    ...
    async (handler, payload, requestId, registry, taskSender) => {
      try {
        ...
        taskSender({
          kind: "response",
          requestId,
          payload: pc.concat(pc.encodeU8(0), pc.encodeI64(result)),
        });
      } catch (e) {
        taskSender({
          kind: "response",
    ...
    async (handler, payload, requestId, registry, taskSender) => {
      try {
        ...
        taskSender({
          kind: "response",
          requestId,
          payload: pc.concat(pc.encodeU8(0), new Uint8Array(0)),
        });
      } catch (e) {
        taskSender({
          kind: "response",
    ...
    async (handler, payload, requestId, registry, taskSender) => {
      try {
        ...
        taskSender({
          ...
          payload: pc.concat(
            pc.encodeU8(0),
            pc.concat(pc.encodeI32(result.x), pc.encodeI32(result.y)),
          ),
        });
      } catch (e) {
        taskSender({
    ...
    async (handler, payload, requestId, registry, taskSender) => {
      try {
        ...
        taskSender({
          kind: "response",
          requestId,
          payload: pc.concat(pc.encodeU8(0), pc.encodeF64(result)),
        });
      } catch (e) {
        taskSender({
          kind: "response",
  ...
  [
    ...
    async (handler, payload, requestId, registry, taskSender) => {
      try {
        ...
        const name = _name_r.value;
        offset = _name_r.next;
        const _shapes_r = pc.decodeVec(
          buf,
          offset,
          (buf: Uint8Array, off: number): pc.DecodeResult<any> => {
            let o = off;
              ...
              pc.encodeVec(result.shapes, (item: Shape) =>
                (() => {
                  switch (item.tag) {
                    ...
                    case "Rectangle":
                      return pc.concat(
                        pc.encodeEnumVariant(1),
                        pc.encodeF64(item.width),
                        pc.encodeF64(item.height),
                      );
                    case "Point":
                      return pc.encodeEnumVariant(2);
                    default:
    ...
    async (handler, payload, requestId, registry, taskSender) => {
      try {
        ...
        taskSender({
          ...
          payload: pc.concat(
            pc.encodeU8(0),
            pc.encodeVec(result, (item: Point) =>
              pc.concat(pc.encodeI32(item.x), pc.encodeI32(item.y)),
            ),
          ),
        });
      } catch (e) {
    ...
    async (handler, payload, requestId, registry, taskSender) => {
      try {
        ...
        taskSender({
          ...
          payload: pc.concat(
            pc.encodeU8(0),
            pc.concat(pc.encodeString(result[0]), pc.encodeI32(result[1])),
          ),
        });
      } catch (e) {
        taskSender({
...
export const testbed_schemas: Record<string, MethodSchema> = {
  ...
  divide: {
    ...
    error: {
      kind: "enum",
      variants: [
        { name: "DivisionByZero", fields: null },
        { name: "Overflow", fields: null },
      ],
    },
  },
  lookup: {
  ...
  getPoints: {
    ...
    returns: {
      kind: "vec",
      element: { kind: "struct", fields: { x: { kind: "i32" }, y: { kind: "i32" } } },
    },
    error: null,
  },
  swapPair: {
