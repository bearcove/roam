...
export const messageSchemaRegistry: import("@bearcove/telex-postcard").SchemaRegistry = new Map<
  bigint,
  import("@bearcove/telex-postcard").Schema
>([
  ...
  [5973905932295268573n, {
    id: 0x52e793cb580ee8ddn,
    type_params: [],
    kind: {
      tag: "enum",
      name: "MessagePayload",
  ...
  [12383781214233895103n, {
    id: 0xabdc0766fa9120bfn,
    type_params: [],
    kind: {
      tag: "struct",
      name: "Message",
      fields: [{
        ...
        type_ref: { tag: "concrete", type_id: 0xd9356298b81639acn, args: [] },
        required: true,
      }, { name: "payload", type_ref: { tag: "concrete", type_id: 0x52e793cb580ee8ddn, args: [] }, required: true }],
    },
  }],
]);

export const messageRootRef: import("@bearcove/telex-postcard").TypeRef = {
  tag: "concrete",
