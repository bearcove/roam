// RPC error types matching the Telex spec
// r[impl core.error.telex-error] - TelexError wraps call results
// r[impl call.error.protocol] - Protocol errors use discriminants 1-3

import type { DecodeResult } from "@bearcove/telex-postcard";
