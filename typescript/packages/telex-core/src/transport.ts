 ...
 * transport mechanisms for sending and receiving telex messages.
 *
 * Implementations:
 * - LengthPrefixedFramed (telex-tcp) for byte streams (TCP)
 * - WsTransport (telex-ws) for WebSocket
 */

/**
 * Interface for transports that can send and receive telex messages.
 *
