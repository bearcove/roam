...
const TRANSPORT_HELLO_MAGIC = new Uint8Array([0x54, 0x58, 0x54, 0x48]); // TXTH
const TRANSPORT_ACCEPT_MAGIC = new Uint8Array([0x54, 0x58, 0x54, 0x41]); // TXTA
const TRANSPORT_REJECT_MAGIC = new Uint8Array([0x54, 0x58, 0x54, 0x52]); // TXTR
