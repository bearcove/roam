import type { Schema } from "@bearcove/telex-postcard";
import type { ConnectionSettings, Parity } from "@bearcove/telex-wire";
import { messageSchemasCbor } from "@bearcove/telex-wire";
