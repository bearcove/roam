...
This document is the durable handoff / tracking checklist for bringing the TypeScript implementation to parity with the Rust implementation and therefore the current Telex specification.
...
- Raw CBOR handshake helper code was started in `typescript/packages/telex-core/src/handshake.ts`.
...
- `typescript/packages/telex-wire/src/types.ts`
- `typescript/packages/telex-core/src/session.ts`
- `typescript/packages/telex-wire/src/types.generated.ts`
...
- `rust/telex-types/src/handshake.rs`
- `rust/telex-core/src/handshake.rs`
- `rust/telex-core/src/lib.rs` (`MessagePlan::from_handshake`)
...
- `rust/telex-core/src/session/mod.rs` (`SessionCore::send`)
- `rust/telex-types/src/schema.rs` (`SchemaSendTracker::prepare_send_for_method`)
...
- `rust/telex-core/src/session/mod.rs` (`Session::handle_message`)
- `rust/telex-types/src/schema.rs` (`SchemaRecvTracker::record_received`)
...
- `rust/telex-core/src/session/mod.rs`
- `rust/telex-types/src/schema.rs`
...
- `rust/telex-postcard/src/decode.rs` (`read_opaque_bytes`)
- `rust/telex-postcard/src/deserialize.rs`
- `rust/telex-types/src/message.rs` (`Payload`, `PayloadAdapter`)
...
- `rust/telex-core/src/stable_conduit/mod.rs`
- `docs/content/spec/conn.md`
...
- `docs/content/spec/retry.md`
- Rust operation-store wiring in `rust/telex-core`

---

## Major parity gaps in TypeScript

## A. `telex-wire` still models stale handshake/message shapes

### Problem

`typescript/packages/telex-wire/src/types.ts` still assumes:
...
- [ ] Remove stale postcard-level `Hello` / `HelloYourself` assumptions from `telex-wire`
- [ ] Stop constructing `Message` values with payload tag `"Hello"` or `"HelloYourself"`
- [ ] Decide whether handshake types should live in a dedicated TS handshake module instead of `telex-wire` postcard message helpers
- [ ] Update `telex-wire/src/index.ts` exports accordingly
...
- `typescript/packages/telex-wire/src/types.ts`
- `typescript/packages/telex-wire/src/index.ts`
- `typescript/packages/telex-wire/src/types.generated.ts`
...
`typescript/packages/telex-core/src/session.ts` still contains stale postcard-handshake assumptions in several places, including:
...
- `typescript/packages/telex-core/src/session.ts`
- possibly `typescript/packages/telex-core/src/index.ts`
...
`typescript/packages/telex-core/src/schema_tracker.ts` and `cbor.ts` were written around the old `SchemaMessagePayload` framing model.
...
- `typescript/packages/telex-core/src/schema_tracker.ts`
- `typescript/packages/telex-core/src/cbor.ts`
...
- `typescript/packages/telex-postcard/...`
- `typescript/packages/telex-wire/...`
...
- [ ] Audit `typescript/packages/telex-core/src/stable_conduit.ts` against Rust stable conduit behavior
...
- `typescript/packages/telex-core/src/stable_conduit.ts`
- `typescript/packages/telex-core/src/session.ts`
- `typescript/packages/telex-core/src/transport_prologue.ts`
...
- `typescript/packages/telex-core/src/driver.ts`
- `typescript/packages/telex-core/src/retry.ts`
...
- `typescript/packages/telex-core/src/session.ts`
- `typescript/packages/telex-core/src/stable_conduit.ts`
- channeling runtime pieces under `typescript/packages/telex-core/src/channeling/`
...
`typescript/packages/telex-core/src/connection.ts` and related tests still model old Hello/HelloYourself postcard exchange.
...
- `typescript/packages/telex-core/src/connection.ts`
- `typescript/packages/telex-core/src/connection.channeling.test.ts`
- `typescript/packages/telex-core/src/connection.keepalive.test.ts`

---

## I. `telex-wire` message helper payload shapes are out of date
...
- [ ] Audit all handwritten message helper constructors against `rust/telex-types/src/message.rs`
...
- `xtask/src/main.rs`
- `typescript/packages/telex-wire/src/schemas.generated.ts`
...
- [ ] Fix `telex-wire/src/types.ts` so it reflects current Rust postcard message shapes
...
- [ ] Get `telex-wire` compiling again
...
- [ ] Get `telex-core` compiling again
...
- [ ] Fix `typescript/packages/telex-wire/src/types.ts`
- [ ] Remove stale hello/schema-message assumptions from `typescript/packages/telex-core/src/session.ts`
