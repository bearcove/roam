...
fn handshake_unknown_hello_variant_triggers_goodbye() {
    run_async(async {
        ...
        // `V4` is variant 3, `V5` is variant 4, `V6` is variant 5.
        // We send Hello discriminant=6 to simulate an unknown future version.
        let malformed = vec![0x00, 0x06]; // Message::Hello (0), Hello::<unknown v7> (6)
