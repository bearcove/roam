//! Cross-platform local IPC for telex.
//!
...
///
/// ```
/// use telex_local::path_to_pipe_name;
///
/// let pipe = path_to_pipe_name("/home/user/project/.tracey/daemon.sock");
/// // Returns something like r"\\.\pipe\telex-a1b2c3d4e5f6..."
/// ```
#[cfg(windows)]
...
mod tests {
    ...
    async fn test_unix_roundtrip() {
        ...
        let sock_path = dir.join(format!("telex-local-test-{}.sock", std::process::id()));
