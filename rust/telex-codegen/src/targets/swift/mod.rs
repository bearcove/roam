//! Swift code generation for telex services.
//!
...
pub fn generate_method_ids(methods: &[&MethodDescriptor]) -> String {
    ...
    out.push_str("public enum TelexMethodId {\n");
...
pub fn generate_service_with_bindings(
    ...
    out.push_str("import TelexRuntime\n\n");
...
mod tests {
    ...
    use telex::{Rx, Tx};
    use telex_types::{MethodDescriptor, RetryPolicy, ServiceDescriptor, method_descriptor};
