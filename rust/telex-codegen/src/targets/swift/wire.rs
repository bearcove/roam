...
//! code is driven by facet `Shape`s from `telex_types::message`.
//!
...
fn generate_preamble() -> String {
    ...
    out.push_str("        let len = UInt32(bytes.count)\n");
    out.push_str("        return [\n");
    out.push_str("            UInt8(truncatingIfNeeded: len),\n");
    out.push_str("            UInt8(truncatingIfNeeded: len >> 8),\n");
    out.push_str("            UInt8(truncatingIfNeeded: len >> 16),\n");
    out.push_str("            UInt8(truncatingIfNeeded: len >> 24),\n");
    out.push_str("        ] + bytes\n");
    out.push_str("    }\n\n");
    ...
    out.push_str("        offset += len\n");
    out.push_str("        return .init(payload)\n");
    out.push_str("    }\n\n");
