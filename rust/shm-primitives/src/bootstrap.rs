...
mod tests {
    ...
    fn stream_response_roundtrip_success() {
        let names = BootstrapSuccessNames {
            ...
            doorbell_name: r"\\.\pipe\telex-db-1234".to_string(),
            mmap_ctrl_name: r"\\.\pipe\telex-mc-5678".to_string(),
        };
        ...
        assert_eq!(got_names.doorbell_name, r"\\.\pipe\telex-db-1234");
        assert_eq!(got_names.mmap_ctrl_name, r"\\.\pipe\telex-mc-5678");
    }
