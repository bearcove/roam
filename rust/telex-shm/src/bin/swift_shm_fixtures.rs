...
use telex_shm::framing::{
    DEFAULT_INLINE_THRESHOLD, FLAG_MMAP_REF, FLAG_SLOT_REF, FRAME_HEADER_SIZE, MMAP_REF_ENTRY_SIZE,
    SLOT_REF_ENTRY_SIZE,
};
use telex_shm::peer_table::{PEER_ENTRY_SIZE, PeerTable, bipbuf_pair_size};
use telex_shm::segment::{SegmentConfig, SegmentLayout};
use telex_shm::varslot::{SizeClassConfig, VarSlotPool};
use shm_primitives::{
