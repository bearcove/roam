...
pub trait ConnectionAcceptor: Send + 'static {
    fn accept(
        ...
        metadata: &[telex_types::MetadataEntry],
...
pub struct ConnectionState {
    ...
    schema_recv_tracker: Arc<telex_types::SchemaRecvTracker>,
}
...
fn forwarded_payload<'a>(payload: &'a telex_types::Payload<'static>) -> telex_types::Payload<'a> {
    let telex_types::Payload::PostcardBytes(bytes) = payload else {
        unreachable!("proxy forwarding expects decoded incoming payload bytes")
    };
    telex_types::Payload::PostcardBytes(bytes)
}

fn forwarded_request_body<'a>(body: &'a RequestBody<'static>) -> RequestBody<'a> {
    match body {
        RequestBody::Call(call) => RequestBody::Call(telex_types::RequestCall {
        ...
        RequestBody::Cancel(cancel) => RequestBody::Cancel(telex_types::RequestCancel {
...
fn forwarded_channel_body<'a>(
    body: &'a telex_types::ChannelBody<'static>,
) -> telex_types::ChannelBody<'a> {
    match body {
        telex_types::ChannelBody::Item(item) => {
            telex_types::ChannelBody::Item(telex_types::ChannelItem {
                item: forwarded_payload(&item.item),
            })
        }
        telex_types::ChannelBody::Close(close) => {
            telex_types::ChannelBody::Close(telex_types::ChannelClose {
                metadata: close.metadata.clone(),
            })
        }
        telex_types::ChannelBody::Reset(reset) => {
            telex_types::ChannelBody::Reset(telex_types::ChannelReset {
                metadata: reset.metadata.clone(),
            })
        }
        telex_types::ChannelBody::GrantCredit(credit) => {
            telex_types::ChannelBody::GrantCredit(telex_types::ChannelGrantCredit {
...
impl ConnectionSender {
    ...
    pub(crate) async fn send_with_binder<'a>(
        ...
        binder: Option<&'a dyn telex_types::ChannelBinder>,
    ) -> Result<(), ()> {
    ...
    pub(crate) async fn send_owned(
        &self,
        schemas: Arc<telex_types::SchemaRecvTracker>,
    ...
    pub async fn send_response_for_method<'a>(
        &self,
        request_id: RequestId,
        method_id: telex_types::MethodId,
    ...
    pub(crate) fn prepare_response_from_source(
        ...
        request_id: RequestId,
        method_id: telex_types::MethodId,
        root_type: &telex_types::TypeRef,
        source: &dyn telex_types::SchemaSource,
        response: &mut RequestResponse<'_>,
    ) {
    ...
    pub fn schema_registry(&self) -> telex_types::SchemaRegistry {
...
pub(crate) struct RecvMessage {
    pub schemas: Arc<telex_types::SchemaRecvTracker>,
...
impl Session {
    ...
    fn make_connection_handle(
        ...
        self.conns.insert(
            ...
            ConnectionSlot::Active(ConnectionState {
                ...
                conn_tx,
                closed_tx,
                schema_recv_tracker: Arc::new(telex_types::SchemaRecvTracker::new()),
            }),
        );
        ...
        loop {
            tokio::select! {
                msg = self.rx.recv_msg() => {
                    telex_types::dlog!("[session {:?}] recv_msg returned", self.role);
                    match msg {
                        Ok(Some(msg)) => {
                        ...
                        Ok(None) => {
                            telex_types::dlog!("[session {:?}] recv loop: conduit returned EOF", self.role);
                            if !self.handle_conduit_break(&mut keepalive_runtime).await {
                                telex_types::dlog!("[session {:?}] recv loop: breaking (not resumable)", self.role);
                                break;
                            }
                        }
                        Err(error) => {
                            telex_types::dlog!("[session {:?}] recv loop: conduit recv error: {}", self.role, error);
                            if !self.handle_conduit_break(&mut keepalive_runtime).await {
                                telex_types::dlog!("[session {:?}] recv loop: breaking (not resumable)", self.role);
                                break;
                            }
    ...
    fn resume_from_handshake(
        ...
        if let Some(ConnectionSlot::Active(state)) = self.conns.get_mut(&ConnectionId::ROOT) {
            state.schema_recv_tracker = Arc::new(telex_types::SchemaRecvTracker::new());
        }
        Ok(())
    }
    ...
    async fn handle_message(
        ...
        telex_types::selfref_match!(msg, payload {
            ...
            MessagePayload::RequestMessage(r) => {
                ...
                let response_had_schema_payload = matches!(&r.body, RequestBody::Response(resp) if !resp.schemas.is_empty());
                {
                    ...
                    {
                        let payload = telex_types::SchemaPayload::from_cbor(&schemas_cbor.0)
                            .expect("inlined schemas must be valid CBOR");
                        let (method_id, direction) = match &r.body {
                            RequestBody::Call(call) => {
                                (call.method_id, telex_types::BindingDirection::Args)
                            }
                            RequestBody::Response(_) => {
                                ...
                                (method_id, telex_types::BindingDirection::Response)
                            }
            ...
            MessagePayload::Ping(ping) => {
                let _ = self
                    ...
                    .send(Message {
                        connection_id: conn_id,
                        payload: MessagePayload::Pong(telex_types::Pong { nonce: ping.nonce }),
                    }, None, None)
                    .await;
            }
        ...
        if self
            ...
            .send(
                Message {
                    ...
                    payload: MessagePayload::Ping(telex_types::Ping { nonce }),
                },
                None,
                None,
            )
        ...
        if !conn_id.has_parity(peer_parity) {
            ...
            let _ = self
                ...
                .send(
                    Message {
                        connection_id: conn_id,
                        payload: MessagePayload::ConnectionReject(telex_types::ConnectionReject {
                            metadata: vec![],
                        }),
                    },
                    None,
                    ...
                    .send(
                        Message {
                            ...
                            payload: MessagePayload::ConnectionReject(
                                telex_types::ConnectionReject { metadata: vec![] },
                            ),
                        },
                        None,
                        None,
    ...
    fn close_all_connections(&mut self) {
        ...
        for (conn_id, slot) in self.conns.iter() {
            if let ConnectionSlot::Active(state) = slot {
                telex_types::dlog!("[session {:?}] closing connection {:?}", self.role, conn_id);
                let _ = state.closed_tx.send(true);
            }
        }
        self.conns.clear();
...
struct SendConnState {
    ...
    method_tracker: HashSet<(telex_types::BindingDirection, telex_types::MethodId)>,

    /// Tracks which schemas we have sent on this connection.
    send_tracker: telex_types::SchemaSendTracker,

    /// Maps request_id → method_id for in-flight incoming calls, so we can
    /// look up the method_id when sending the response.
    inflight_incoming: HashMap<RequestId, telex_types::MethodId>,
    ...
    inflight_outgoing: HashMap<RequestId, telex_types::MethodId>,
}
...
impl SendConnState {
    fn new() -> Self {
        SendConnState {
            ...
            send_tracker: telex_types::SchemaSendTracker::new(),
...
impl SessionCore {
    ...
    pub(crate) async fn send<'a>(
        ...
        mut msg: Message<'a>,
        binder: Option<&'a dyn telex_types::ChannelBinder>,
        forwarded_schemas: Option<&telex_types::SchemaRecvTracker>,
    ) -> Result<(), ()> {
        let tx = {
    ...
    pub(crate) fn schema_registry(&self, conn_id: ConnectionId) -> telex_types::SchemaRegistry {
    ...
    pub(crate) fn prepare_response_from_source(
        ...
        let conn_state = inner
            ...
            .or_insert_with(SendConnState::new);
        conn_state.inflight_incoming.remove(&request_id);
        let key = (telex_types::BindingDirection::Response, method_id);
        if conn_state.method_tracker.contains(&key) {
            return;
        }
        let cbor = conn_state.send_tracker.prepare_send(
            method_id,
            telex_types::BindingDirection::Response,
            root_type,
            source,
        );
        if !cbor.is_empty() {
    ...
    fn prepare_response_schemas(
        ...
        let prepared = match &response.ret {
            telex_types::Payload::Value { shape, .. } => {
                match conn_state
                    .send_tracker
            ...
            telex_types::Payload::PostcardBytes(_) => {
    ...
    fn prepare_call_schemas(
        ...
        request_id: RequestId,
        method_id: telex_types::MethodId,
        call: &mut telex_types::RequestCall<'_>,
        forwarded_schemas: Option<&telex_types::SchemaRecvTracker>,
    ) {
        conn_state.inflight_outgoing.insert(request_id, method_id);
        let key = (telex_types::BindingDirection::Args, method_id);
        if conn_state.method_tracker.contains(&key) {
            return;
        }
        ...
        let prepared = match &call.args {
            ...
            telex_types::Payload::PostcardBytes(_) => {
                ...
                call.schemas = conn_state.send_tracker.prepare_send(
                    method_id,
                    telex_types::BindingDirection::Args,
                    &root,
                    source,
                );
                true
    ...
    fn send_msg<'a>(
        ...
        Box::pin(async move {
            ...
            let result = if let Some(binder) = binder {
                telex_types::with_channel_binder(binder, || permit.send(msg))
            } else {
                permit.send(msg)
            };
