//! C bindings for telex shared-memory primitives.
//!
...
#[cfg(unix)]
struct TelexMmapAttachment {
    region: MmapRegion,
}

/// Guest-side mmap attachments resolved by (map_id, map_generation).
pub struct TelexMmapAttachments {
    control_fd: RawFd,
    mappings: Mutex<HashMap<(u32, u32), TelexMmapAttachment>>,
}
...
// `telex_bipbuf_header_t` (128 bytes, same field offsets, cache-line aligned).
//
// The data region is expected to immediately follow the header at +128.

#[unsafe(no_mangle)]
pub extern "C" fn telex_bipbuf_header_size() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_bipbuf_init(header_ptr: *mut c_void, capacity: u32) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_bipbuf_capacity(header_ptr: *const c_void) -> u32 {
...
/// `header_ptr` must point to a valid, initialized `BipBufHeader`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_bipbuf_load_write_acquire(header_ptr: *const c_void) -> u32 {
    let header = header_ptr as *const BipBufHeader;
...
/// `header_ptr` must point to a valid, initialized `BipBufHeader`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_bipbuf_load_read_acquire(header_ptr: *const c_void) -> u32 {
    let header = header_ptr as *const BipBufHeader;
...
/// `header_ptr` must point to a valid, initialized `BipBufHeader`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_bipbuf_load_watermark_acquire(header_ptr: *const c_void) -> u32 {
    let header = header_ptr as *const BipBufHeader;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_bipbuf_try_grant(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_bipbuf_commit(header_ptr: *mut c_void, len: u32) -> i32 {
    let header = header_ptr as *mut BipBufHeader;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_bipbuf_try_read(
    header_ptr: *mut c_void,
    out_offset: *mut u32,
    out_len: *mut u32,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_bipbuf_release(header_ptr: *mut c_void, len: u32) -> i32 {
    let header = header_ptr as *mut BipBufHeader;
...
///
/// Does NOT initialize the pool — call `telex_var_slot_pool_init` for that.
...
/// - `classes` must point to a valid array of `num_classes` `TelexSizeClass` entries.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_attach(
    region_ptr: *mut u8,
    region_len: usize,
    base_offset: u64,
    classes: *const TelexSizeClass,
    num_classes: usize,
) -> *mut TelexVarSlotPool {
    ...
    Box::into_raw(Box::new(TelexVarSlotPool {
        inner: pool,
        region_ptr,
        region_len,
        base_offset,
...
/// # Safety
///
/// `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
/// The underlying region must be writable and large enough for the configured
/// size classes.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_init(pool: *mut TelexVarSlotPool) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_update_region(
    pool: *mut TelexVarSlotPool,
    region_ptr: *mut u8,
    region_len: usize,
) {
    let pool = unsafe { &mut *pool };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_alloc(
    pool: *const TelexVarSlotPool,
    size: u32,
    owner: u8,
    out_handle: *mut TelexVarSlotHandle,
) -> i32 {
    let pool = unsafe { &*pool };
    match pool.inner.allocate(size, owner) {
        Some(h) => {
            unsafe {
                *out_handle = TelexVarSlotHandle {
...
/// `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_mark_in_flight(
    pool: *const TelexVarSlotPool,
    handle: TelexVarSlotHandle,
) -> i32 {
    let pool = unsafe { &*pool };
    if let Ok(mut states) = pool.states.lock()
...
/// `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_free(
    pool: *const TelexVarSlotPool,
    handle: TelexVarSlotHandle,
) -> i32 {
    let pool = unsafe { &*pool };
...
/// `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_free_allocated(
    pool: *const TelexVarSlotPool,
    handle: TelexVarSlotHandle,
) -> i32 {
    unsafe { telex_var_slot_pool_free(pool, handle) }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_payload_ptr(
    pool: *const TelexVarSlotPool,
    handle: TelexVarSlotHandle,
) -> *mut u8 {
    let pool = unsafe { &*pool };
...
/// `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_slot_state(
    pool: *const TelexVarSlotPool,
    handle: TelexVarSlotHandle,
) -> i32 {
    let pool = unsafe { &*pool };
...
/// `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_slot_size(
    pool: *const TelexVarSlotPool,
    class_idx: u8,
) -> u32 {
    let pool = unsafe { &*pool };
...
/// `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_recover_peer(
    pool: *const TelexVarSlotPool,
    peer_id: u8,
) {
    let pool = unsafe { &*pool };
...
/// `classes` must point to a valid array of `num_classes` `TelexSizeClass` entries.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_calculate_size(
    classes: *const TelexSizeClass,
    num_classes: usize,
) -> u64 {
...
/// `telex_var_slot_pool_attach`. After this call, `pool` is dangling and must
/// not be used again.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_var_slot_pool_destroy(pool: *mut TelexVarSlotPool) {
    if !pool.is_null() {
...
#[repr(C)]
pub struct TelexShmBootstrapResponseInfo {
    pub status: u8,
    pub peer_id: u32,
    pub payload_len: u16,
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_shm_bootstrap_request_encode(
    sid_ptr: *const u8,
    sid_len: usize,
    out_buf: *mut u8,
    out_buf_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_shm_bootstrap_request_decode(
    buf_ptr: *const u8,
    buf_len: usize,
...
/// - `out_written` must be non-null and writable.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_shm_bootstrap_response_encode(
    status: u8,
    peer_id: u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_shm_bootstrap_response_decode(
    buf_ptr: *const u8,
    buf_len: usize,
    out_info: *mut TelexShmBootstrapResponseInfo,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_shm_bootstrap_response_send_unix(
    control_fd: i32,
    status: u8,
    peer_id: u32,
    payload_ptr: *const u8,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_shm_bootstrap_response_recv_unix(
    control_fd: i32,
    payload_buf: *mut u8,
...
#[unsafe(no_mangle)]
pub extern "C" fn telex_shm_bootstrap_request_header_size() -> u32 {
    BOOTSTRAP_REQUEST_HEADER_LEN as u32
}

#[unsafe(no_mangle)]
pub extern "C" fn telex_shm_bootstrap_response_header_size() -> u32 {
...
#[cfg(unix)]
fn recv_mmap_attach(fd: RawFd) -> std::io::Result<Option<(OwnedFd, TelexMmapAttachMessage)>> {
    let mut payload = [0_u8; TelexMmapAttachMessage::LEN];
    ...
    if n < TelexMmapAttachMessage::LEN as isize {
    ...
    Ok(Some((
        owned_fd,
        TelexMmapAttachMessage::from_le_bytes(payload),
    )))
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_mmap_control_send(
    control_fd: i32,
    mapping_fd: i32,
    map_id: u32,
    map_generation: u32,
    ...
    #[cfg(unix)]
    {
        ...
        let msg = TelexMmapAttachMessage {
            map_id,
            map_generation,
            mapping_length,
        };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_mmap_attachments_create(control_fd: i32) -> *mut TelexMmapAttachments {
    if control_fd < 0 {
        return core::ptr::null_mut();
    }
    ...
    Box::into_raw(Box::new(TelexMmapAttachments {
        control_fd,
...
/// # Safety
///
/// `attachments` must be a valid pointer returned by `telex_mmap_attachments_create`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_mmap_attachments_drain_control(
    attachments: *mut TelexMmapAttachments,
) -> i32 {
...
/// # Safety
///
/// - `attachments` must be valid and created by `telex_mmap_attachments_create`.
/// - `out_ptr` must be non-null and writable.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_mmap_attachments_resolve_ptr(
    attachments: *const TelexMmapAttachments,
    map_id: u32,
    map_generation: u32,
    map_offset: u64,
    payload_len: u32,
...
/// `telex_mmap_attachments_create`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_mmap_attachments_destroy(attachments: *mut TelexMmapAttachments) {
    if !attachments.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_atomic_load_u32_acquire(ptr: *const u32) -> u32 {
...
/// `ptr` must point to a naturally-aligned `u32` in valid shared memory.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_atomic_store_u32_release(ptr: *mut u32, value: u32) {
    let a = ptr as *const AtomicU32;
...
///   failure).
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_atomic_compare_exchange_u32(
    ptr: *mut u32,
    expected: *mut u32,
    desired: u32,
) -> i32 {
...
/// `ptr` must point to a naturally-aligned `u32` in valid shared memory.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_atomic_fetch_add_u32(ptr: *mut u32, value: u32) -> u32 {
    let a = ptr as *const AtomicU32;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_atomic_load_u64_acquire(ptr: *const u64) -> u64 {
...
/// `ptr` must point to a naturally-aligned `u64` in valid shared memory.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_atomic_store_u64_release(ptr: *mut u64, value: u64) {
    let a = ptr as *const AtomicU64;
    unsafe { (*a).store(value, Ordering::Release) };
}
...
///   failure).
#[unsafe(no_mangle)]
pub unsafe extern "C" fn telex_atomic_compare_exchange_u64(
    ptr: *mut u64,
    expected: *mut u64,
    desired: u64,
) -> i32 {
...
fn to_handle(ffi: &TelexVarSlotHandle) -> SlotRef {
    SlotRef {
