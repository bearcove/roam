...
func atomicLoadU32Acquire(_ pointer: UnsafeRawPointer) -> UInt32 {
    telex_atomic_load_u32_acquire(pointer.assumingMemoryBound(to: UInt32.self))
}

@inline(__always)
func atomicStoreU32Release(_ pointer: UnsafeMutableRawPointer, _ value: UInt32) {
    telex_atomic_store_u32_release(pointer.assumingMemoryBound(to: UInt32.self), value)
}
...
func atomicCompareExchangeU32(
    ...
    telex_atomic_compare_exchange_u32(
...
func atomicFetchAddU32(_ pointer: UnsafeMutableRawPointer, _ value: UInt32) -> UInt32 {
    telex_atomic_fetch_add_u32(pointer.assumingMemoryBound(to: UInt32.self), value)
}

@inline(__always)
func atomicLoadU64Acquire(_ pointer: UnsafeRawPointer) -> UInt64 {
    telex_atomic_load_u64_acquire(pointer.assumingMemoryBound(to: UInt64.self))
}

@inline(__always)
func atomicStoreU64Release(_ pointer: UnsafeMutableRawPointer, _ value: UInt64) {
    telex_atomic_store_u64_release(pointer.assumingMemoryBound(to: UInt64.self), value)
}
...
func atomicCompareExchangeU64(
    ...
    telex_atomic_compare_exchange_u64(
