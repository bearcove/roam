...
#ifndef TELEX_SHM_FFI_H
#define TELEX_SHM_FFI_H
 ...
 */
typedef struct TelexMmapAttachments TelexMmapAttachments;

/**
 * Opaque wrapper around the Rust VarSlotPool (heap-allocated, Box'd).
 */
typedef struct TelexVarSlotPool TelexVarSlotPool;

/**
 * A size class descriptor for variable-size slot pools.
 */
typedef struct TelexSizeClass {
  uint32_t slot_size;
  uint32_t count;
} TelexSizeClass;
 ...
 */
typedef struct TelexVarSlotHandle {
  uint8_t class_idx;
  uint8_t extent_idx;
  uint32_t slot_idx;
  uint32_t generation;
...
typedef struct TelexShmBootstrapResponseInfo {
  uint8_t status;
  uint32_t peer_id;
  uint16_t payload_len;
} TelexShmBootstrapResponseInfo;

uint32_t telex_bipbuf_header_size(void);
 ...
 */
void telex_bipbuf_init(void *header_ptr, uint32_t capacity);
 ...
 */
uint32_t telex_bipbuf_capacity(const void *header_ptr);
 ...
 * `header_ptr` must point to a valid, initialized `BipBufHeader`.
 */
uint32_t telex_bipbuf_load_write_acquire(const void *header_ptr);
 ...
 * `header_ptr` must point to a valid, initialized `BipBufHeader`.
 */
uint32_t telex_bipbuf_load_read_acquire(const void *header_ptr);
 ...
 * `header_ptr` must point to a valid, initialized `BipBufHeader`.
 */
uint32_t telex_bipbuf_load_watermark_acquire(const void *header_ptr);
 ...
 */
int32_t telex_bipbuf_try_grant(void *header_ptr, uint32_t len, uint32_t *out_offset);
 ...
 */
int32_t telex_bipbuf_commit(void *header_ptr, uint32_t len);
 ...
 */
int32_t telex_bipbuf_try_read(void *header_ptr, uint32_t *out_offset, uint32_t *out_len);
 ...
 */
int32_t telex_bipbuf_release(void *header_ptr, uint32_t len);
 ...
 */
struct TelexVarSlotPool *telex_var_slot_pool_attach(uint8_t *region_ptr,
                                                  uintptr_t region_len,
                                                  uint64_t base_offset,
                                                  const struct TelexSizeClass *classes,
 ...
 * size classes.
 */
void telex_var_slot_pool_init(struct TelexVarSlotPool *pool);
 ...
 */
void telex_var_slot_pool_update_region(struct TelexVarSlotPool *pool,
                                      uint8_t *region_ptr,
                                      uintptr_t region_len);
 ...
 */
int32_t telex_var_slot_pool_alloc(const struct TelexVarSlotPool *pool,
                                 uint32_t size,
                                 uint8_t owner,
                                 struct TelexVarSlotHandle *out_handle);
 ...
 * `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
 */
int32_t telex_var_slot_pool_mark_in_flight(const struct TelexVarSlotPool *pool,
                                          struct TelexVarSlotHandle handle);
 ...
 * `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
 */
int32_t telex_var_slot_pool_free(const struct TelexVarSlotPool *pool,
                                struct TelexVarSlotHandle handle);
 ...
 * `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
 */
int32_t telex_var_slot_pool_free_allocated(const struct TelexVarSlotPool *pool,
                                          struct TelexVarSlotHandle handle);
 ...
 */
uint8_t *telex_var_slot_pool_payload_ptr(const struct TelexVarSlotPool *pool,
                                        struct TelexVarSlotHandle handle);
 ...
 * `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
 */
int32_t telex_var_slot_pool_slot_state(const struct TelexVarSlotPool *pool,
                                      struct TelexVarSlotHandle handle);
 ...
 * `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
 */
uint32_t telex_var_slot_pool_slot_size(const struct TelexVarSlotPool *pool, uint8_t class_idx);
 ...
 * `pool` must be a valid pointer returned by `telex_var_slot_pool_attach`.
 */
void telex_var_slot_pool_recover_peer(const struct TelexVarSlotPool *pool, uint8_t peer_id);
 ...
 * `classes` must point to a valid array of `num_classes` `TelexSizeClass` entries.
 */
uint64_t telex_var_slot_pool_calculate_size(const struct TelexSizeClass *classes,
                                           uintptr_t num_classes);
 ...
 * not be used again.
 */
void telex_var_slot_pool_destroy(struct TelexVarSlotPool *pool);

int32_t telex_shm_bootstrap_request_encode(const uint8_t *sid_ptr,
                                          uintptr_t sid_len,
                                          uint8_t *out_buf,
                                          uintptr_t out_buf_len,
                                          uintptr_t *out_written);

int32_t telex_shm_bootstrap_request_decode(const uint8_t *buf_ptr,
                                          uintptr_t buf_len,
                                          const uint8_t **out_sid_ptr,
                                          uint16_t *out_sid_len);

int32_t telex_shm_bootstrap_response_encode(uint8_t status,
                                           uint32_t peer_id,
...
int32_t telex_shm_bootstrap_response_decode(const uint8_t *buf_ptr,
                                           uintptr_t buf_len,
                                           struct TelexShmBootstrapResponseInfo *out_info,
                                           const uint8_t **out_payload_ptr);

int32_t telex_shm_bootstrap_response_send_unix(int32_t control_fd,
                                              uint8_t status,
                                              uint32_t peer_id,
                                              const uint8_t *payload_ptr,
                                              uintptr_t payload_len,
...
int32_t telex_shm_bootstrap_response_recv_unix(int32_t control_fd,
                                              uint8_t *payload_buf,
...
uint32_t telex_shm_bootstrap_request_header_size(void);

uint32_t telex_shm_bootstrap_response_header_size(void);
 ...
 * Returns 0 on success, -1 on error.
 */
int32_t telex_mmap_control_send(int32_t control_fd,
                               int32_t mapping_fd,
                               uint32_t map_id,
 ...
 */
struct TelexMmapAttachments *telex_mmap_attachments_create(int32_t control_fd);
 ...
 */
int32_t telex_mmap_attachments_drain_control(struct TelexMmapAttachments *attachments);
 ...
 */
int32_t telex_mmap_attachments_resolve_ptr(const struct TelexMmapAttachments *attachments,
                                          uint32_t map_id,
                                          uint32_t map_generation,
                                          uint64_t map_offset,
 ...
 */
void telex_mmap_attachments_destroy(struct TelexMmapAttachments *attachments);
 ...
 */
uint32_t telex_atomic_load_u32_acquire(const uint32_t *ptr);
 ...
 * `ptr` must point to a naturally-aligned `u32` in valid shared memory.
 */
void telex_atomic_store_u32_release(uint32_t *ptr, uint32_t value);
 ...
 *   failure).
 */
int32_t telex_atomic_compare_exchange_u32(uint32_t *ptr, uint32_t *expected, uint32_t desired);
 ...
 * `ptr` must point to a naturally-aligned `u32` in valid shared memory.
 */
uint32_t telex_atomic_fetch_add_u32(uint32_t *ptr, uint32_t value);
 ...
 */
uint64_t telex_atomic_load_u64_acquire(const uint64_t *ptr);
 ...
 * `ptr` must point to a naturally-aligned `u64` in valid shared memory.
 */
void telex_atomic_store_u64_release(uint64_t *ptr, uint64_t value);
 ...
 *   failure).
 */
int32_t telex_atomic_compare_exchange_u64(uint64_t *ptr, uint64_t *expected, uint64_t desired);

#endif  /* TELEX_SHM_FFI_H */
